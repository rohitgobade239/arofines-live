    ...
    <div className="pasting-page">
      ...
      <section className="jd-section">
        <Container>
          ...
          <p className="jd-pragrap">The position of Area Sales Manager (Ahmedabad) reports to the National Head of Sales & Marketing. The candidate will be responsible for managing the sales operations of the organization in Hyderabad & Andhra Pradesh in line with organizational strategy in a fully compliant manner. The position requires that the candidate be of high integrity and good moral values.</p>
          ...
          <p className="jd-pragrap1">The candidate will be solely responsible for the business coming from Hyderabad & AP assigned territory by servicing existing clients & dealers; reviving old clients and dealers if the need be, identifying new clients, new geographies, new products and identifying new dealers. The candidate would also be responsible for identifying clients using products from competitions and suggesting our products as an alternative thus providing the client with a complete basket of products to cater to their needs as a preferred one stop shop. </p>
