...
export const ThankYou = ({onClose}) => {
  return (
    <section className="thankyou-section text-center py-5 shadow-box">
      <div className="talk-overly">
        <Container className="form-main-cst-pm position-relative">
          <Card className="product-box-form">
            <Card.Body className="p-5">
              <h2 className="title-main-product text-success mb-3">
                <i className="bi bi-check-circle-fill me-2"></i>Specification
                Submitted!
              </h2>
              <p className="lead mb-4">
                We have received your request. Our team will get back to you within the next 24 hours.
              </p>
              {/* <div className="button-group button-group-ex">
                <Button className="talk-expert-btn">
                 ...
                 <div className="button-group button-group-ex">
                <Button className="talk-expert-btn" onClick={()=>window.location.reload()}>
                 Reload page
                </Button>
              </div>
            </Card.Body>
